...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x00000000, 36, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ActiveLocale */  \
...
\
  ...
  { ZAP_MIN_MAX_DEFAULTS_INDEX(0), 0x00004003, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* StartUpOnOff */  \
...
\
  ...
  { ZAP_LONG_DEFAULTS_INDEX(8), 0x00000000, 65, ZAP_TYPE(CHAR_STRING), 0 }, /* Description */  \
  { ZAP_SIMPLE_DEFAULT(0xFFFF), 0x00000001, 2, ZAP_TYPE(ENUM16), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* StandardNamespace */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  ...
  { ZAP_CLUSTER_INDEX(22), 5, 36 }, \
  { ZAP_CLUSTER_INDEX(27), 3, 83 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x0000010A,1},{0x00000027,1}}
